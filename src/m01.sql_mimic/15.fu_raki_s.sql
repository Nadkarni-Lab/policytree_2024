...
DROP TABLE IF EXISTS r_policytree_mimic_2023.fu_raki_s;
CREATE TABLE r_policytree_mimic_2023.fu_raki_s AS
WITH episode AS (
    ...
    FROM r_policytree_mimic_2023.cohort AS pt
             ...
             INNER JOIN aims_mimiciv_derived.kdigo_stages AS h2
                        ON h1.subject_id = h2.subject_id AND
                           ...
                           DATETIME_ADD(h1.charttime, INTERVAL '48' HOUR) > h2.charttime AND
...
FROM r_policytree_mimic_2023.fu_raki_s;
-- 6660, 6660
